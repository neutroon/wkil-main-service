...
2. Read the thread metadata through the trusted LangGraph service.
3. Update metadata only when no valid title exists, preserving manual renames and titles created by another client.
4. Forward the run to the agent service.
