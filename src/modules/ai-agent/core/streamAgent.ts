 ...
 *
 * This function wraps the agentGraphV2.streamEvents() call to yield
 ...
 * }
 */
import { agentGraphV2, type AgentGraphV2Params } from "./agentGraphV2";
import { makeEmptyEvidence } from "./agentState";
import { logger } from "@utils/logger";
import prisma from "@config/prisma";
import { DEFAULT_AI_TRUTHFULNESS_POLICY } from "./aiEngine.utils";

export async function* streamAgentGraph(params: AgentGraphV2Params) {
  ...
  const threadId = String(params.agentTurnId);
  ...
  const eventStream = agentGraphV2.streamEvents(
    initialState,
    {
      version: "v2",
      configurable: {
  ...
  const finalState = await agentGraphV2.getState({
